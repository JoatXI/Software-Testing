...
class Carpark:
    ...
    def load_data_from_file(self):
        cars = []
        try:
            with open(r"C:\Users\JoatXI\Documents\week6\week6\data\vehicles.json", "rt") as file:
    ...
    def save_to_file(self):
        with open(r"C:\Users\JoatXI\Documents\week6\week6\data\vehicles.json", "wt") as file:
